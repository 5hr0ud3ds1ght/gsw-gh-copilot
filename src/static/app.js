document.addEventListener("DOMContentLoaded", () => {
  ...
  function formatParticipants(activityName, participants) {
    if (!participants.length) {
      return '<li class="participant-row participant-empty">No students signed up yet</li>';
    }
      ...
      .map((participant) => {
        ...
        return `
          <li class="participant-row">
            ...
            >
              <span class="participant-delete-icon" aria-hidden="true">&times;</span>
            </button>
          </li>
        `;
      })
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear loading message and reset dropdown options before rebuilding UI.
